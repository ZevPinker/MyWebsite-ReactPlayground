    ...
    return (
        <div className="app-container">
            ...
            <footer className="social-links">
                ...
                <a href="https://github.com/ZevPinker" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="/resume.html" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <mask id="cvMask">
                                <rect rx="3" width="24" height="24" fill="white" />
                                <text x="12" y="16.5" fontFamily="Arial Black, sans-serif" fontSize="11" fontWeight="900" fill="black" textAnchor="middle">CV</text>
                            </mask>
                        </defs>
                        <rect width="24" height="24" fill="currentColor" mask="url(#cvMask)" />
                    </svg>
                </a>
            </footer>
        </div>
